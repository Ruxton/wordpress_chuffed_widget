...
You can add the widget via the Widget section in Appearance settings.

You can also add a shortcode to any page using the format [chuffed campaign_id=000]
where 000 is your campaign id.
